  ...
  return (
    <Container>
      <Cadastro>
        ...
        <Card>
          <Campo>
            <label>Nome: </label> <input placeholder="Informe nome da instituição..."/>
          </Campo>
          <Campo>
            <label>Telefone: </label> <input type="number" placeholder="Informe telefone da instituição..."/>
          </Campo>
          <Campo>
            <label>Endereço: </label> <textarea placeholder="Informe endereço da instituição..." />
          </Campo>
